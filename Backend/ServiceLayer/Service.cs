...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    public class Service
    {
        ...
        ///You should call this function when the program starbs. </summary>
        public Response LoadData()
        {

            Response r = us.LoadData();
            Response r2 = bs.LoadData();
            if (r.ErrorOccured | r2.ErrorOccured)
            {
                return new Response(r.ErrorMessage + " " + r2.ErrorMessage);
            }
            return new Response();
        ...
        {
            return bs.AddTask(email, creatorEmail, boardName, title, description, dueDate);
        }
        public Response<IList<Tuple<string, string>>> GetBoards(string userEmail)
        {
            return bs.GetBoards(userEmail);
        }
        /// <summary>
        ...
        {
            return bs.GetColumns(email, creatorEmail, boardName);
        }
        ...
        public Response RemoveBoard(string userEmail, string creatorEmail, string name)
        {
            ...
            return bs.RemoveBoard(userEmail,creatorEmail, name);
        ...
        {
            return bs.AssignTask(userEmail, creatorEmail, boardName, columnOrdinal, taskId, emailAssignee);
        }
        ...
        {
            return bs.GetBoardNames(userEmail);
        }

        public Response<IList<Board>> GetBoardNamesByBOBJ(string userEmail)
        {
            return bs.GetBoardNamesByBOBJ(userEmail);
        }
