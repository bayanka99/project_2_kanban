...
namespace IntroSE.Kanban.Backend.DataAccessLayer
{
    internal abstract class DalController
    {
        ...
        public List<DTO> Select(string attribute,string val)
        {
            List<DTO> results = new List<DTO>();
            using (var connection = new SQLiteConnection(_connectionString))
            {
                SQLiteCommand command = new SQLiteCommand(null, connection);
                command.CommandText = $"select * from {_tableName} where {attribute}={val};";
                SQLiteDataReader dataReader = null;
                try
                {
                    connection.Open();
        ...
        public bool Delete(DTO DTOObj)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionString))
            {
                ...
                {
                    log.Error("failed to delete from DB ::::  " + e.Message);
